        ...
        <div class="page-container">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <center><img src="img/pupr.jpeg" width="1100" class="img img-responsive" height="3000"></center><br>
                            <strong class="col-md-12" style="margin-top: 5rem;">Selamat Datang Admin Dinas PUPR</strong>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="copyright">
                                    <p>© 2024 Dinas PUPR Aceh Tengah </p>
                                </div>
                            </div>
                        </div>
                    </div>
