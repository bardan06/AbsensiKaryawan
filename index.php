...
<body>
        ...
        <div class="row">
          <div class="col-lg-7">
            <div class="hero-banner__img">
              <img class="img-fluid" src="img/PUPR.png" alt="">
            </div>
          </div>
          <div class="col-lg-5 pt-5">
            <div class="hero-banner__content">
              <h1>WEBSITE PUPR </h1>
              <p>Website ini berfungsi sebagai absensi karyawan dan sebagai sistem informasi karyawan dinas pupr aceh tengah.</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="row">
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                ...
                <p class="card-feature__subtitle">Dinas PUPR Aceh Tengah  </p>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                ...
                <p class="card-feature__subtitle">(0643) 7426406</p>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                ...
                <p class="card-feature__subtitle">0822 1343 4156</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="section-margin">
      ...
      <div class="col-lg-12 danger text-center zero-panel">
        ...
        <ul class="list-inline" id="chart-skill">
          <li><a href="login.php" target="_blank"><button class="btn btn-warning" style="size: 50px;"> Admin</button></a>
          </li><br>
          <li><a href="karyawan/login_karyawan.php" target="_blank"><button class="btn btn-primary" style="size: 50px;"> Karyawan</button></a>
          </li>
 ...
 <script>document.write(new Date()());</script> Takengon Aceh Tenggah 1 januari 2024 | Pupracehtenggah@gmail.com <i class="" aria-hidden="true"></i><a href="https://colorlib.com" target="_blank"></a>
